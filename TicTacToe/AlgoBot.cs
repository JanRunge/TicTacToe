...
namespace TicTacToe
{
    class AlgoBot : Bot
    {
        public AlgoBot(Game i_game, Boolean Color)
        {
            myGame = i_game;
            this.Color = Color;
        }
        ...
        int count;
        private double[] findBestMove( Game i_game)
        {
            count = 0;
            ...
            return returnAuswahl[bestEvaluation(returnAuswahl, this.Color)];

        }
        private void print(List<int[]> returnAuswahl)
        {
            foreach(int[] element in returnAuswahl)
            {
        ...
        private int bestEvaluation(List<int[]> auswahl, Boolean Color)
        {
